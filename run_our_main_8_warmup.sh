...
python our_main.py --data_name 2spirals --methods cd_runi_inter --gpu 0 --vocab_size 2 --eval_every 2000 --num_epochs 100000 --surrogate_iter_per_epoch 100 --ebm_iter_per_epoch 10 --batch_size 128 --delta_t 0.001 --lr 0.001 --warmup_k 1e5 #> $log_dir/output1.log 2>&1 &
