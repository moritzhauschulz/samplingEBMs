...
python baselines_main.py --method gfn --pretrained_ebm methods/ed_ebm/experiments/2spirals/2spirals_2/ckpts/model_100000.pt --data_name 2spirals --n_iters 10000 --lr 1e-3 --type tblb --hid_layer 3 --hid 256 --print_every 1000 --eval_every 1000 --glr 1e-3 --zlr 1 --rand_coef 0 > ${output_files}_output1.log 2>&1 &
wait
