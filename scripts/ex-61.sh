...
python -u methods_MNIST/our_main.py --MCMC_refinement 10 --sampler 'dmala' --mixer_step 1 --mixer_type data_mean --itr_save 100 --dfs_init_from_checkpoint 1 --base_dist data_mean --init_iter 1000 --source uniform --optimal_temp 0 --delta_t 0.05 --optimal_temp_use_median 1 --lr 0.0001 --q_weight 0 --start_temp 1 --end_temp 1 --num_epochs 500 --dataset_name static_mnist --methods velo_efm_ebm_bootstrap --norm_by_max 1 --norm_by_sum 0 > ${output_date}/output1.log 2>&1 &

python -u methods_MNIST/our_main.py --MCMC_refinement 10 --sampler 'dmala' --p_control 1e-3 --l2 1e-4 --mixer_step 1 --mixer_type data_mean --itr_save 100 --dfs_init_from_checkpoint 1 --base_dist data_mean --init_iter 1000 --source uniform --optimal_temp 0 --delta_t 0.05 --optimal_temp_use_median 1 --lr 0.0001 --q_weight 0 --start_temp 1 --end_temp 1 --num_epochs 500 --dataset_name static_mnist --methods velo_efm_ebm_bootstrap --norm_by_max 1 --norm_by_sum 0 > ${output_date}/output2.log 2>&1 &
wait
