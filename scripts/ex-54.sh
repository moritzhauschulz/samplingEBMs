...
# python -u methods_MNIST/our_main.py --dfs_init_from_checkpoint 1 --base_dist data_mean --init_iter 1000 --optimal_temp 0 --delta_t 0.2 --optimal_temp_use_median 1 --lr 0.0001 --q_weight 0 --start_temp 1 --end_temp 1 --num_epochs 500 --dataset_name static_mnist --methods velo_efm_ebm_bootstrap --norm_by_max 1 --norm_by_sum 0 > ${output_date}/output5.log 2>&1 &
# python -u methods_MNIST/our_main.py --dfs_init_from_checkpoint 1 --base_dist data_mean --init_iter 1000 --source uniform --optimal_temp 0 --delta_t 0.2 --optimal_temp_use_median 1 --lr 0.0001 --q_weight 0 --start_temp 1 --end_temp 1 --num_epochs 500 --dataset_name static_mnist --methods velo_efm_ebm_bootstrap --norm_by_max 1 --norm_by_sum 0 > ${output_date}/output6.log 2>&1 &

# python -u methods_MNIST/our_main.py --dfs_init_from_checkpoint 1 --base_dist zero --init_iter 500 --optimal_temp 0 --delta_t 0.2 --optimal_temp_use_median 1 --lr 0.0001 --q_weight 0 --start_temp 1 --end_temp 1 --num_epochs 500 --dataset_name static_mnist --methods velo_efm_ebm_bootstrap --norm_by_max 1 --norm_by_sum 0 > ${output_date}/output7.log 2>&1 &
# python -u methods_MNIST/our_main.py --dfs_init_from_checkpoint 1 --base_dist zero --init_iter 500 --source uniform --optimal_temp 0 --delta_t 0.2 --optimal_temp_use_median 1 --lr 0.0001 --q_weight 0 --start_temp 1 --end_temp 1 --num_epochs 500 --dataset_name static_mnist --methods velo_efm_ebm_bootstrap --norm_by_max 1 --norm_by_sum 0 > ${output_date}/output8.log 2>&1 &
wait
