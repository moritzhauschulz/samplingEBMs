...
python baselines_main.py --data_name 2spirals --n_iters 100000 --lr 1e-3 --type tblb --hid_layer 3 --hid 256 --print_every 5000 --eval_every 5000 --glr 1e-3 --zlr 1 --rand_coef 0 --back_ratio 0.5 --lin_k 1 --warmup_k 1e5 --with_mh 1  > ${output_files}_output5.log 2>&1 &
python baselines_main.py --data_name 2spirals --n_iters 100000 --lr 1e-3 --type tblb --hid_layer 3 --hid 256 --print_every 5000 --eval_every 5000 --glr 1e-3 --zlr 1 --rand_coef 0 --back_ratio 0.5 --lin_k 1 --warmup_k 1e5 --with_mh 0  > ${output_files}_output6.log 2>&1 &
