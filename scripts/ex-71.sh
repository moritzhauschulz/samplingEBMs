...
python -u methods_MNIST/main.py --delta_t 0.05 --methods velo_dfs --scheduler_type linear --source omniglot --num_epoch 300 --epoch_save 25 > ${output_date}/output4.log 2>&1 &
