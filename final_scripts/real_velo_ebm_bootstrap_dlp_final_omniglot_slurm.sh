...
#on dfm
python -u methods/main.py --dfs 0 --l2 0.00001 --step_size_start 0.2 --adaptive_step_size 1 --dfs_warmup_iter 2000 --sampler dmala --MCMC_refinement_dfs 40 --recycle_dfs_sample 1  --dataset_name omniglot --batch_size 100 --delta_t 0.05 --methods velo_bootstrap_ebm --scheduler_type linear --source uniform --num_itr 50000 --eval_every 5000 --itr_save 5000 --dfs_per_ebm 1  > ${output_date}/output${counter}.log 2>&1 & ((counter++))
wait
