...
#on dfm
python -u methods/main.py --l2 0.1 --dfs 0 --ebm_init_mean 0 --dataset_name 2spirals --delta_t 0.05 --methods velo_ebm --scheduler_type linear --source mask --num_itr 100000 --eval_every 25000 --itr_save 1000 --dfs_per_ebm 1  > ${output_date}/output${counter}.log 2>&1 & ((counter++))
python -u methods/main.py --l2 0.1 --dfs 1 --ebm_init_mean 0 --dataset_name 2spirals --delta_t 0.05 --methods velo_ebm --scheduler_type linear --source mask --num_itr 100000 --eval_every 25000 --itr_save 1000 --dfs_per_ebm 1  > ${output_date}/output${counter}.log 2>&1 & ((counter++))

python -u methods/main.py --p_control 0.001 --l2 0.1 --dfs 0 --ebm_init_mean 0 --dataset_name 2spirals --delta_t 0.05 --methods velo_ebm --scheduler_type linear --source mask --num_itr 100000 --eval_every 25000 --itr_save 1000 --dfs_per_ebm 1  > ${output_date}/output${counter}.log 2>&1 & ((counter++))
python -u methods/main.py --p_control 0.001 --l2 0.1 --dfs 1 --ebm_init_mean 0 --dataset_name 2spirals --delta_t 0.05 --methods velo_ebm --scheduler_type linear --source mask --num_itr 100000 --eval_every 25000 --itr_save 1000 --dfs_per_ebm 1  > ${output_date}/output${counter}.log 2>&1 & ((counter++))
wait

python -u methods/main.py --l2 0.1 --dfs 0 --ebm_init_mean 0 --dataset_name 2spirals --delta_t 0.05 --methods velo_ebm --scheduler_type linear --source mask --num_itr 100000 --eval_every 25000 --itr_save 1000 --dfs_per_ebm 10  > ${output_date}/output${counter}.log 2>&1 & ((counter++))
python -u methods/main.py --l2 0.1 --dfs 1 --ebm_init_mean 0 --dataset_name 2spirals --delta_t 0.05 --methods velo_ebm --scheduler_type linear --source mask --num_itr 100000 --eval_every 25000 --itr_save 1000 --dfs_per_ebm 10  > ${output_date}/output${counter}.log 2>&1 & ((counter++))

python -u methods/main.py --p_control 0.001 --l2 0.1 --dfs 0 --ebm_init_mean 0 --dataset_name 2spirals --delta_t 0.05 --methods velo_ebm --scheduler_type linear --source mask --num_itr 100000 --eval_every 25000 --itr_save 1000 --dfs_per_ebm 10  > ${output_date}/output${counter}.log 2>&1 & ((counter++))
python -u methods/main.py --p_control 0.001 --l2 0.1 --dfs 1 --ebm_init_mean 0 --dataset_name 2spirals --delta_t 0.05 --methods velo_ebm --scheduler_type linear --source mask --num_itr 100000 --eval_every 25000 --itr_save 1000 --dfs_per_ebm 10  > ${output_date}/output${counter}.log 2>&1 & ((counter++))
wait
