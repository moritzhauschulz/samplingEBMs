...
# python -u methods/main.py --dfs 1 --l2 0.1 --step_size 1 --sampler dmala --MCMC_refinement 5 --dataset_name 2spirals --delta_t 0.05 --methods velo_bootstrap_ebm --scheduler_type linear --source mask --num_itr 200000 --eval_every 100000 --itr_save 1000 --dfs_per_ebm 1  > ${output_date}/output${counter}.log 2>&1 & ((counter++))

# python -u methods/main.py --dfs 1 --l2 0.1 --step_size 1 --sampler dmala --MCMC_refinement 5 --dataset_name checkerboard --delta_t 0.05 --methods velo_bootstrap_ebm --scheduler_type linear --source mask --num_itr 200000 --eval_every 100000 --itr_save 1000 --dfs_per_ebm 1  > ${output_date}/output${counter}.log 2>&1 & ((counter++))

# python -u methods/main.py --dfs 1 --l2 0.1 --step_size 1 --sampler dmala --MCMC_refinement 5 --dataset_name circles --delta_t 0.05 --methods velo_bootstrap_ebm --scheduler_type linear --source mask --num_itr 200000 --eval_every 100000 --itr_save 1000 --dfs_per_ebm 1  > ${output_date}/output${counter}.log 2>&1 & ((counter++))

# python -u methods/main.py --dfs 1 --l2 0.1 --step_size 1 --sampler dmala --MCMC_refinement 5 --dataset_name moons --delta_t 0.05 --methods velo_bootstrap_ebm --scheduler_type linear --source mask --num_itr 200000 --eval_every 100000 --itr_save 1000 --dfs_per_ebm 1  > ${output_date}/output${counter}.log 2>&1 & ((counter++))
