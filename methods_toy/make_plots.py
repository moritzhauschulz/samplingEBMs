...
if __name__ == '__main__':
    args = get_args()
    # Read the CSV file
    make_plots(args.csv_file, last_n=args.last_n, output_dir=args.output, hamming_mmd_reference_value=args.mmd_reference_value, nll_reference_value=args.nll_reference_value)
