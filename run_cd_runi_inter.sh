...
python main.py --data_name pinwheel --methods cd_runi_inter --gpu 0 --vocab_size 2 --epoch_save 25 --batch_size 128 --delta_t 0.01

# run interleaved EBM training with discrete flow sampler on checkerboard
python main.py --data_name checkerboard --methods cd_runi_inter --gpu 0 --vocab_size 2 --epoch_save 25 --batch_size 128 --delta_t 0.01
