...
from methods.mask_dfs_ce.model import MLPScore, EBM
from methods.mask_dfs_ce.model import MLPModel as MLPFlow
from methods.mask_dfs_ce.model import alt_MLPModel as alt_MLPFlow
...
def gen_samples(model, args, batch_size=None, t=0.0, xt=None, eta=0):
    ...
    while t < 1.0:
        ...
        with torch.no_grad():
            R = F.softmax(model(xt, t_), dim=-1) #CAREFUL: THIS IS STILL A VALID R! –> check mask_dfs_ce_2
